...
public class Lab2ex2 {
    public static void main(String[] args) {
        ...
        if (a < b) {
            if ((z > a) && (z < b)) {
                System.out.print("Z входит в промежуток[ab]");
            } else if (z < a) {
                System.out.print("не входит ни в 1 промежуток");
            } else if (c < d) {
                if ((z > c) && (z < d)) {
                    System.out.print("Z входит в промежуток[cd]");
                } else if (z < c) {
                    System.out.print("не входит ни в 1 промежуток");
                } else if (z > d) {
                    System.out.print("не входит ни в 1 промежуток");
                ...
                if ((z > c) && (z < d)) {
                    System.out.print("Z входит в промежуток[cd and ab]");
                }
            } else if ((z < a) && (z < d)) {
